...
- Adding a listed apartment with details:
  ...
  - Image upload
- Functionality for scheduling a visit to the apartment: The system provides 8 time slots per working day for visits over the next 5 days starting from the current day (which can be manually disabled).
